...
- **Migración 0003 corrida en Supabase (2026-07-13)** y verificación e2e en vivo OK: crear "Seguro auto $45.000 → Visa CMR / categoría Seguros" no movió nada; al Aprobar, Visa CMR subió a $45.000 por facturar (cupo disp. $955.000), Banco $500.000 y Efectivo $100.000 intactos, GASTOS MES $45.000, y Gasto real atribuyó los $45.000 a Seguros; re-aprobar mostró el aviso sin duplicar. Datos de prueba limpiados tras verificar.

### Estado v1: LISTO PARA USO REAL. Fases 0–6 + reportes + auditoría QA (11/11 reglas) + fixes menores + fix gasto real en curso + override de cupo + deuda total visible + gastos recurrentes a TC (migración 0003 corrida + e2e OK), desplegado en Vercel. Pendiente único: validar instalación PWA en un iPhone real (criterio 11 del brief).
